...
function WelcomePage() {
  ...
  return (
    ...
    <div className="flex justify-center items-center w-full h-screen bg-[#fffdef]">
      ...
      <div className="border mt-[25vh] pt-[25vh] pb-[5vh] overflow-auto h-[75vh] w-full md:h-[70%] md:pt-[0] md:mt-[30vh] flex flex-col gap-10 justify-center items-center md:grid md:grid-cols-[2fr_1fr] md:grid-rows-1 md:items-center">
        <div className="border mt-[80vh] md:mt-[0] flex flex-col h-fit gap-20 md:flex-row md:justify-around w-[100%] md:h-[90%] md:ml-[20%] md:items-center ">
