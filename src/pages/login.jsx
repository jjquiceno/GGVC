  ...
  return (
    <>
      <div className="w-screen h-screen box-border flex flex-col m-0 lg:w-screen lg:h-screen lg:box-border lg:flex lg:flex-row lg:m-0">
        <motion.div
          className="bg-gradient-to-r from-[#A6AB90] to-[#E9EDC9] rounded-br-[50px] rounded-bl-[50px] mb-[20px] lg:rounded-bl-[0] lg:top-0 lg:left-0 lg:m-0 lg:p-0 lg:h-full lg:w-1/2 lg:flex lg:items-center lg:justify-center lg:rounded-r-2xl"
